...
### Added
- Open VSX support
- Fixes typo in extension display name
...
- Piano roll visualization powered by `wave-roll` library
- MIDI playback using Tone.js synthesis
- Support for `.mid` and `.midi` file extensions
